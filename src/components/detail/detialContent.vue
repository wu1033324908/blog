          ...
          <div class="review-version">
            <div class="form-box">
              <div class="article-cont">
                ...
                <img src="../../assets/img/wz_img1.jpg">
                ...
                <form class="layui-form">
                  <div class="layui-form-item layui-form-text">
                    <div class="layui-input-block">
                      <textarea name="desc" placeholder="既然来了，就说几句" class="layui-textarea" ref="desc"></textarea>
                    </div>
                  </div>
                  <div class="layui-form-item">
                    <div class="layui-input-block" style="text-align: right;">
                      <a href="javascript:;" class="layui-btn" @click="submitForm">確定</a>
                    </div>
                  </div>
                </form>
              </div>
            ...
            <div class="list-cont">
              <message v-for="(messageData, index) in messageDatas" :key="index" :name="messageData.name" :ct="messageData.ct" :dateTime="messageData.dateTime" :imgUrl="messageData.imgUrl"></message>
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  data() {
    return {
      messageDatas: [{
          name: '吴亦凡',
          dateTime: '2019-04-17',
          imgUrl: 'https://offlintab.firefoxchina.cn/static/img/search/baidu_web.png',
          ct: '出来挨打!'
        },
        {
          name: '吴亦凡',
  ...
  methods: {
    submitForm:function (e) {
      let othis = this
      // console.log(othis.$refs.desc.value);
      this.messageDatas.push({
          name: '吴亦凡',
          dateTime: '2019-04-17',
          imgUrl: 'https://offlintab.firefoxchina.cn/static/img/search/baidu_web.png',
          ct: othis.$refs.desc.value
      })
      // debugger;
      return false;
    }
